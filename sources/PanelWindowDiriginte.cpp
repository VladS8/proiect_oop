...
PanelWindowDiriginte::PanelWindowDiriginte(QWidget *parent, const QString &numeDiriginte, const QString &numeClasa, const QString &idDiriginte)
    : QMainWindow(parent)
{
    ...
    connect(m_showStudentsButton, &QPushButton::clicked, this, [this, idDiriginte]() {
        showStudentsOnPushButtonClicked(idDiriginte);
    });
...
void PanelWindowDiriginte::showStudentsOnPushButtonClicked(const QString& idDiriginte) {
    try {
        ...
        query.prepare(R"(
               ...
               FROM
                   clasa
               JOIN
                   elev ON clasa.id = elev.id_clasa
               WHERE clasa.id_diriginte = :idDiriginte
            )");
...
PanelWindowDiriginte::~PanelWindowDiriginte() = default;
